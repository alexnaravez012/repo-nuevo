...
import {AddSpecificProductComponent} from '../add-specific-product/add-specific-product.component';
...
export class AddProductModalComponent implements OnInit {
  ...
  constructor(public categoriesService: BillingService ,public dialogRef: MatDialogRef<AddProductModalComponent>,public dialog: MatDialog,@Inject(MAT_DIALOG_DATA) public data: DialogData) { }
  products;
  codeToPut;
  code;
  isAdmin;
  ...
  openNewSpecificProduct(product){

    var dialogRef;
              dialogRef = this.dialog.open(AddSpecificProductComponent, {
                height:'450px',
                width: '600px',
                data: {idgeneric: product.id_PRODUCT,category: this.data.category,measures: this.measures,brands: this.brands,lastBrand: this.lastBrand,editingProduct:this.editingProduct, idCategory: this.idCategory,productToPut: this.productToPut,productToPost: this.productToPost, products: this.products, codeToPut: this.codeToPut, code: this.code, isAdmin: this.isAdmin, editingCode: this.editingCode, idThirdFather: this.idThirdFather, codeToPost: this.codeToPost, idProduct: this.idProduct, idCode: this.idCode
                }
              });

  dialogRef.afterClosed(a=>{
    this.ngOnInit();
  })
