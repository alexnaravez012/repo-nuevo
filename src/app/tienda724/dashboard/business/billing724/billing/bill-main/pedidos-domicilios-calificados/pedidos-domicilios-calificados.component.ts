...
@Component({
  selector: 'app-pedidos-domicilios-calificados',
  templateUrl: './pedidos-domicilios-calificados.component.html',
  styleUrls: ['./pedidos-domicilios-calificados.component.css']
})
export class PedidosDomiciliosCalificadosComponent implements OnInit {
  id_store;
