...
@Component({
  selector: 'app-pedidos-restaurantes-creados',
  templateUrl: './pedidos-restaurantes-creados.component.html',
  styleUrls: ['./pedidos-restaurantes-creados.component.css']
})
export class PedidosRestaurantesCreadosComponent implements OnInit {
  ...
  updateDataRecibidos(){
    ...
    //-TIMER-//
    this.intervalUpdate = setInterval(function(main:PedidosRestaurantesCreadosComponent){
      main.UpdateTimer();
    },1000,this);
    //-TIMER-//
  }
