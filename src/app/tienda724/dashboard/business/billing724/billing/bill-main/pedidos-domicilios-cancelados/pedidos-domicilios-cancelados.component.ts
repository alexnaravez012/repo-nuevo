...
@Component({
  selector: 'app-pedidos-domicilios-cancelados',
  templateUrl: './pedidos-domicilios-cancelados.component.html',
  styleUrls: ['./pedidos-domicilios-cancelados.component.css']
})
export class PedidosDomiciliosCanceladosComponent implements OnInit {
  id_store;
