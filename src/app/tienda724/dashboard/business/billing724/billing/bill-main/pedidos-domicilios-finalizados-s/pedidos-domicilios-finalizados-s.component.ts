...
@Component({
  selector: 'app-pedidos-domicilios-finalizados-s',
  templateUrl: './pedidos-domicilios-finalizados-s.component.html',
  styleUrls: ['./pedidos-domicilios-finalizados-s.component.css']
})
export class PedidosDomiciliosFinalizadosSComponent implements OnInit {
  id_store;
