...
@Component({
  selector: 'app-add-general-product.',
  templateUrl: './add-general-product.component.html',
  styleUrls: ['./add-general-product.component.scss']
})
export class AddGeneralProduct implements OnInit {

  constructor(public categoriesService: BillingService ,public dialogRef: MatDialogRef<AddGeneralProduct>,public dialog: MatDialog,@Inject(MAT_DIALOG_DATA) public data: DialogData) { }
  products;
  codeToPut;
  code;
  isAdmin;
  ...
  modal5 = false;
  addingCode = false;
  taxes = [{id:1,value:0},{id:21,value:5},{id:2,value:10},{id:3,value:19}];
